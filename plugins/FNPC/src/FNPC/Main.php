...
class Main extends \pocketmine\plugin\PluginBase implements \pocketmine\event\Listener
{
	...
	{
		unset($command,$label);
//        if($sender->getName() !== 'Angel_XX' AND $sender->getName() !== 'gu_yu' AND $sender instanceof \pocketmine\Player and $sender->isOp())return;
		if(!isset($args[0]))
		{
			unset($sender,$args);
			return false;
	...
	{
	 if($event->getPacket() instanceof \pocketmine\network\protocol\InteractPacket and !$event->getPlayer()->isSpectator()){
