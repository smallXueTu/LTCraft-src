...
class Vector3 {
	...
	public function getSide($side, $step = 1){
		switch((int) $side){
			case Vector3::SIDE_DOWN://下
				return new Vector3($this->x, $this->y - $step, $this->z);
			case Vector3::SIDE_UP://上
				return new Vector3($this->x, $this->y + $step, $this->z);
	...
	public function distanceNoY(Vector3 $pos){
		return sqrt($this->distanceSquaredNoY($pos));
	}
	 ...
	 * @return number
	 */
	public function distanceSquaredNoY(Vector3 $pos){
		return pow($this->x - $pos->x, 2) + pow($this->z - $pos->z, 2);
	}
