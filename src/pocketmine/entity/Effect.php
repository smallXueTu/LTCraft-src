...
class Effect {
	...
	public static function init(){
		...
		self::$effects[Effect::FLOATING] = new Effect(Effect::FLOATING, '漂浮', 255, 0, 255);
	}
    ...
    /**
     * @param Effect $special
     */
    public function setSpecial(bool $special): Effect
    {
	...
	public function applyEffect(Entity $entity){
		switch($this->id){
			...
			case Effect::WITHER:
				$ev = new EntityDamageEvent($entity, EntityDamageEvent::CAUSE_MAGIC, ($this->special?$entity->getMaxHealth() * 0.1:1));
				$entity->attack($ev->getFinalDamage(), $ev);
				break;
