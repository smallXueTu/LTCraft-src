...
class Color {
	...
	const COLOR_DYE_BLACK = 0;//dye colors  黑色
	const COLOR_DYE_RED = 1;//红色
	const COLOR_DYE_GREEN = 2;//绿色
	const COLOR_DYE_BROWN = 3;//棕色
	const COLOR_DYE_BLUE = 4;//蓝色
	const COLOR_DYE_PURPLE = 5;//紫色
	const COLOR_DYE_CYAN = 6;//青色
	const COLOR_DYE_LIGHT_GRAY = 7;//浅灰色
	const COLOR_DYE_GRAY = 8;//灰色
	const COLOR_DYE_PINK = 9;//粉色
	const COLOR_DYE_LIME = 10;//石灰色
	const COLOR_DYE_YELLOW = 11;//黄色
	const COLOR_DYE_LIGHT_BLUE = 12;//浅蓝色
	const COLOR_DYE_MAGENTA = 13;//品红
	const COLOR_DYE_ORANGE = 14;//橙色
	const COLOR_DYE_WHITE = 15;//白色
