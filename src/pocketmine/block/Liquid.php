...
abstract class Liquid extends Transparent {
	...
	public function onUpdate($type){
		$plot=MyPlot::getInstance()->getPlotByPosition($this);
		if((MyPlot::getInstance()->isLevelLoaded($this->level->getName()) and $plot===null) or $this->level->getName()=='create')return;
	...
	private function flowIntoBlock(Block $block, $newFlowDecay){
		...
		if(MyPlot::getInstance()->isLevelLoaded($this->level->getName()) and $plot===null)return;
