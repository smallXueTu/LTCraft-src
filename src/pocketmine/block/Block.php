...
class Block extends Position implements BlockIds, Metadatable{	
	...
	public static function init(){
		if(self::$list === null){
			...
			self::$list[self::BONE_BLOCK] = Bone::class;
			self::$list[self::RED_FLOWER] = Flower::class;
			self::$list[self::WHITE_DAISIES] = WhiteDaisies::class;
			self::$list[self::SHIZHONGJI] = ShiZhongji::class;
			...
			self::$list[self::TARA_STEEL_BLOCL] = TaraSteelBlock::class;
			...
			self::$list[self::MANACACHE] = ManaCache::class;
			self::$list[self::GLOWING_OBSIDIAN] = GlowingObsidian::class;
			self::$list[self::NETHER_REACTOR] = NetherReactor::class;
			self::$list[self::CONCRETE] = Concrete::class;
			self::$list[self::LIVE_WOOD] = LiveWood::class;
			
			self::$list[self::MANA_DIAMOND_BLOCK] = ManaDiamondBlock::class;
			...
			self::$list[self::LIVING_STONES] = LivingStones::class;
			self::$list[self::MANA_STEEL_BLOCK] = ManaSteelBlock::class;
			...
			self::$list[self::MANA_GLASS] = ManaGlass::class;
			...
			self::$list[self::TARA_CONDENSATION_PLATE] = TaraCondensationPlate::class;
			self::$list[self::NOTEBLOCK] = Noteblock::class;
			self::$list[self::SKULL_BLOCK] = SkullBlock::class;
			self::$list[self::MANACHEST] = ManaTransformation::class;
