...
abstract class Biome {
	...
	const HELL = 8;//地狱
	const END = 9;//末地
	const FROZEN_OCEAN = 10;//冰冻海洋
	const FROZEN_RIVER = 11;//冰冻河
	const ICE_PLAINS = 12;//雪地平原
	const ICE_MOUNTAINS = 13;//雪地山脉
	const MUSHROOM_ISLAND = 14;//蘑菇岛
	const MUSHROOM_ISLAND_SHORE = 15;//蘑菇岛海岸
	const BEACH = 16;//海滩
	const DESERT_HILLS = 17;//沙漠山丘
	const FOREST_HILLS = 18;//森林山丘
	const TAIGA_HILLS = 19;//热带深林山脉
	...
	const MEGA_TAIGA = 32;
	const MEGA_TAIGA_HILLS = 33;////热带山脉
	const EXTREME_HILLS_PLUS = 34;//大极端山
	const SAVANNA = 35;//稀树大草原
	const SAVANNA_PLATEAU = 36;
	const MESA = 37;//台面
	const MESA_PLATEAU_F = 38;//台面高原
	const MESA_PLATEAU = 39;//台面高原
