...
namespace pocketmine {
	...
	if(version_compare("7.0", PHP_VERSION) > 0){
		echo "[CRITICAL] 你需要PHP版本 >= 7.0" . PHP_EOL;
...
// error_reporting(-1);
	...
	$logger = new MainLogger(\pocketmine\DATA.'plugins/LTCraft/Saves/', \pocketmine\ANSI);
	...
	if(extension_loaded("xdebug")){
		...
		您在运行PocketMine时启用了Xdebug。这对性能有重大影响。
