...
class RakLibServer extends \Thread{
	...
	public function __construct(\ThreadedLogger $logger, \ClassLoader $loader, $port, $interface = "0.0.0.0"){
		...
		$this->EventQueue = new \Threaded;
		$this->STA = new \Threaded;
	...
	public function addSTAQueue($str){
		$this->STA[] = $str;
	}


	public function getSTAQueue(){
		return $this->STA->shift();
	}
	
	public function addEventQueue($str){
		$this->EventQueue[] = $str;
	}
